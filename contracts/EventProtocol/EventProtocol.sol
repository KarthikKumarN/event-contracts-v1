...
import { IEventProtocol } from "../EventProtocol/IEventProtocol.sol";
 ...
 */
contract EventProtocol is ReentrancyGuard, IEventProtocol, Pausable {
    // Using safeERC20
    ...
    /// @dev See {IEventProtocol-setEventDeployer}.
    ...
    /// @dev See {IEventProtocol-setCommission}.
    ...
    /// @dev See {IEventProtocol-pause}.
    function pause() external onlyAdmin {
        _pause();
    }

    /// @dev See {IEventProtocol-unpause}.
    ...
    /// @dev See {IEventProtocol-bookEvent}.
    function bookEvent(
        uint256 _eventId,
    ...
    /// @dev See {IEventProtocol-bookEventOwner}.
    ...
    /// @dev See {IEventProtocol-mintBukNFTOwner}.
    ...
    /// @dev See {IEventProtocol-getEventDetails}.
    ...
    /// @dev See {IEventProtocol-getEventBookingDetails}.
    ...
    /// @dev See {IEventProtocol-isBookingTradeable}.
    ...
    /// @dev See {IEventProtocol-getRoyaltyInfo}.
    ...
    /// @dev See {IEventProtocol-getWallets}.
    function getWallets()
        external
        view
        returns (
    ...
    /// @dev See {IEventProtocol-mintBukNFT}.
